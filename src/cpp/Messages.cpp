...
MessageAnswer SendQuestionMessage(const char* title, const char* message, MessageButtons buttons) {
    ...
    switch (buttons) {
    case MessageButtons::YesNo: winButtons = MB_YESNO; break;
    case MessageButtons::YesNoCancel: winButtons = MB_YESNOCANCEL; break;
    case MessageButtons::OkCancel: winButtons = MB_OKCANCEL; break;
    }

    int result = MessageBox(g_hwnd, message, title, winButtons | MB_ICONQUESTION);
    switch (result) {
    case IDYES: return MessageAnswer::Yes;
    case IDNO: return MessageAnswer::No;
    case IDOK: return MessageAnswer::Ok;
    case IDCANCEL:
    default: return MessageAnswer::Cancel;
    }
}
