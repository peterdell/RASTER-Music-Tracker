...
BOOL CInstrumentChangeDlg::OnInitDialog()
{
    ...
    for (i = 0; i < CNotes::NOTESNUM; i++)
    {
        ...
        ((CComboBox*)GetDlgItem(IDC_COMBO5))->AddString(note);
        ((CComboBox*)GetDlgItem(IDC_COMBO6))->AddString(note);
    }
...
void CInstrumentChangeDlg::OnFullRanges()
{
    ...
    if (!iinfo.count)
    {
        ...
        ((CComboBox*)GetDlgItem(IDC_COMBO6))->SetCurSel(CNotes::NOTESNUM - 1);
