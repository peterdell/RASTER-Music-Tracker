...
Changes in RMT 1.35
-------------------
- Added technical documentation of the RMT tracker and the RMT current and future module file format version 
- Reorganized and cleaned up the file system structure of the repository.
